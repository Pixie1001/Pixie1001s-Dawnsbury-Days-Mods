...
namespace Dawnsbury.Mods.Creatures.RoguelikeMode.Content.Creatures.L2
{
    ...
    public class AnimatedStatue
    {
        ...
        {
            return new Creature(IllustrationName.UnknownCreature, "Animated Statue", [Trait.Construct, Trait.Earth, Trait.Mindless], 3, 9, 4, new Defenses(19, 12, 5, 5), 35, new Abilities(4, -2, 5, -5, 0, -5), new Skills(athletics: 11))
