...
namespace Dawnsbury.Mods.Creatures.RoguelikeMode.Content.Creatures {
    ...
    public class DrowHighPriestess {
        ...
        public static Creature Create() {
            Creature monster = new Creature(Illustrations.DrowHighPriestess, "Drow High Priestess",
                [Trait.Chaotic, Trait.Evil, Trait.Elf, Trait.Humanoid, Trait.Female, ModTraits.Drow, Trait.MetalArmor, ModTraits.SpellcasterMutator],
