...
namespace Dawnsbury.Mods.Creatures.RoguelikeMode.Tables {
    ...
    internal static class EncounterTables {
        ...
        public static void LoadEncounterTables() {
            ...
            encounters[1].Add(new TypedEncounterCampaignStop<Colosseum1Lv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<Colosseum2Lv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<CorruptedSwampLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<DrowAmbushLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<RatSwarmLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<InquisitrixTrapLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<SpiderNestLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<TempleOfTheSpiderQueenLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<AbandonedTempleLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<FungalForestlv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<HideAndSeekLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<ShadowCasterSanctumLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<MysteriousRoom_FeyL1>());
            encounters[1].Add(new TypedEncounterCampaignStop<MysteriousRoom_HomunculusL1>());
            encounters[1].Add(new TypedEncounterCampaignStop<MysteriousRoom_ArtRoomL1>());
            encounters[1].Add(new TypedEncounterCampaignStop<GraveEncounterLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<HatcheryLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<RitualSiteLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<DrowPatrolLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<MerfolkHuntingPartyLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<CultOfTheBrineLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<ChosenOfTheKrakenLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<DrowSalavagingPartyLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<KoboldWarrenLv1>());
            encounters[1].Add(new TypedEncounterCampaignStop<KoboldAmbushLv1>());

            // level3Encounters
            encounters[2].Add(new TypedEncounterCampaignStop<AlchemicalAmbushLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<BesetByMinnowsLv3>());
            encounters[2].Add(new TypedEncounterCampaignStop<Colosseum1Lv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<Colosseum2Lv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<CorruptedSwampLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<DrowAmbushLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<RatSwarmLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<InquisitrixTrapLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<SpiderNestLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<TempleOfTheSpiderQueenLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<AbandonedTempleLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<FungalForestlv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<HideAndSeekLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<ShadowCasterSanctumLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<MysteriousRoom_FeyL1>());
            encounters[2].Add(new TypedEncounterCampaignStop<MysteriousRoom_HomunculusL1>());
            encounters[2].Add(new TypedEncounterCampaignStop<MysteriousRoom_ArtRoomL1>());
            encounters[2].Add(new TypedEncounterCampaignStop<GraveEncounterLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<HatcheryLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<RitualSiteLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<DrowPatrolLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<MerfolkHuntingPartyLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<CultOfTheBrineLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<ChosenOfTheKrakenLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<DrowSalavagingPartyLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<KoboldWarrenLv1>());
            encounters[2].Add(new TypedEncounterCampaignStop<KoboldAmbushLv1>());
            ...
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<HallOfSmokeLv1>());
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<AqueductsLv1>());
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<AntiPartyLv1>());
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<MaidenOfTheLostLv1>());
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<MotherOfThePoolLv1>());
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<CroneOfTheWildsLv1>());
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<GrandStaircaseL1>());
            eliteEncounters[1].Add(new TypedEncounterCampaignStop<LairOfTheDriderLv1>());

            // level3EliteEncounters
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<HallOfSmokeLv1>());
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<AqueductsLv1>());
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<AntiPartyLv1>());
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<MaidenOfTheLostLv1>());
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<MotherOfThePoolLv1>());
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<CroneOfTheWildsLv1>());
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<GrandStaircaseL1>());
            eliteEncounters[2].Add(new TypedEncounterCampaignStop<LairOfTheDriderLv1>());
