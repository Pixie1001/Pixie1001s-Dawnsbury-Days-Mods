...
namespace Dawnsbury.Mods.Creatures.RoguelikeMode.Encounters.Level3
{
    ...
    internal class CroneOfTheWildsLv3 : Level3EliteEncounter
    {
        public CroneOfTheWildsLv3(string filename) : base("Mother of the Pool", filename, eliteRewards: new List<(Item, string)> {
